...
See the plugin's [design spec §4.8](../../docs/martech/2026-05-27-data-mbox-auto-discovery-design.md#48-display-reporting-de-duplication-fix-from-peer-review-feedback-1)
for the de-duplication semantics.
